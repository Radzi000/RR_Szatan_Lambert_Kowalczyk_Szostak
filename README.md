...
Current implementation boundary before Workstream C:
...
- Workstream C should consume those deterministic A/B outputs rather than
  rebuilding its own data or baseline layer
