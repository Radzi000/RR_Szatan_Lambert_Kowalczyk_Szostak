"""Run NES optimization for the third local strategy (Strategy2)."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run NES optimization for Strategy2 / third strategy.")
    add_common_args(parser)
    args = parser.parse_args(argv)
    settings = runtime_settings_from_args(args)
    output_dir = Path(args.output_dir) / "optimization" / "strategy3_nes"
