"""Run NES optimization for the first local strategy (Strategy0)."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run NES optimization for Strategy0 / first strategy.")
    add_common_args(parser)
    args = parser.parse_args(argv)
    output_dir = Path(args.output_dir) / "optimization" / "strategy1_nes"
